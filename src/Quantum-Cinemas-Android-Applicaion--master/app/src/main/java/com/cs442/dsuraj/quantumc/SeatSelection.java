    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        A1.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(colorid==(-1654272)) {
                    System.out.println("Tôi đang ở chỗ được chọn");
                   ...
                   // toast.show();
                    ...
                    System.out.println("Đã đặt ghế");
                    Toast toast= Toast.makeText(getApplicationContext(),"Xin lỗi, ghế này đã có người đặt.",Toast.LENGTH_SHORT);
                    toast.show();
                }
                else if(colorid== (-7886485)){
                    System.out.println("Ghế chưa được chọn");
...
//                    toast.show();
                    ...
                    Toast toast= Toast.makeText(getApplicationContext(),"Xin lỗi, ghế này đã có người đặt.",Toast.LENGTH_LONG);
                    toast.show();
                }
                else if(colorid== (-7886485)){
                    //   Toast toast= Toast.makeText(getApplicationContext(),"You have unselected this seat.",Toast.LENGTH_LONG);
    ...
    public void seat_information(View V){
        ...
        if(seats_counter!= 0){
            ...
            Toast toast= Toast.makeText(getApplicationContext(),"Vui lòng chọn ghế",Toast.LENGTH_LONG);
            toast.show();
        }
