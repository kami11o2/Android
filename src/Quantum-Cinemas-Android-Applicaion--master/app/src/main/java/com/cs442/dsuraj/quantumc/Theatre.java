...
public class Theatre extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        distance1 = distance(20.999799, 105.828345);
        if(distance1 == 0) {
            Toast.makeText(getApplicationContext(), "Please Switch on GPS to find the Theatre Distance", Toast.LENGTH_SHORT).show();
            amcdist.setText(Integer.toString((int) (distance1*1.609344)) + " km");
            distance1 = distance(21.020083, 105.781001);
            regaldist.setText(Integer.toString((int) (distance1*1.609344)) + " mi");
            distance1 = distance(21.025113, 105.853350);
            landmark.setText(Integer.toString((int) (distance1*1.609344)) + " mi");
                ...
                public void onRefresh() {
                    ...
                    ( new Handler()).postDelayed(new Runnable() {
                        ...
                        public void run() {
                            ...
                            amcdist.setText(Integer.toString((int) (distance1*1.609344)) + " km");
                            distance1 = distance(21.020083, 105.781001);
                            regaldist.setText(Integer.toString((int) (distance1*1.609344)) + " km");
                            distance1 = distance(21.025113, 105.853350);
                            landmark.setText(Integer.toString((int) (distance1*1.609344)) + " km");
                        }
                    },2000);
                }
            });
        ...
        a1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("theatre", "CGV Artemis");
        ...
        RC1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("movie_id", movie);
                intent.putExtra("date", date);
                intent.putExtra("theatre", "CGV Phạm Hùng");
        ...
        LMC1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("movie_id", movie);
                intent.putExtra("date", date);
                intent.putExtra("theatre", "CGV Hoàn Kiếm");
